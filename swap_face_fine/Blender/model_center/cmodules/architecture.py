...
from .normalization import SPADE, equal_lr, SPADE_TwoPath
...
class SPADEResnetBlock(nn.Module):
    def __init__(self, fin, fout, opt, use_se=False, dilation=1):
        ...
        ic = 3
        self.norm_0 = SPADE(spade_config_str, fin, ic, PONO=opt.PONO, use_apex=False)
        self.norm_1 = SPADE(spade_config_str, fmiddle, ic, PONO=opt.PONO, use_apex=False)
        if self.learned_shortcut:
            self.norm_s = SPADE(spade_config_str, fin, ic, PONO=opt.PONO, use_apex=False)

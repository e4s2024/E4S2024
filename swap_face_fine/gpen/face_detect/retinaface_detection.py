...
from swap_face_fine.gpen.face_detect.data import cfg_re50
from swap_face_fine.gpen.face_detect.layers.functions.prior_box import PriorBox
from swap_face_fine.gpen.face_detect.utils.nms.py_cpu_nms import py_cpu_nms
from swap_face_fine.gpen.face_detect.facemodels.retinaface import RetinaFace
from swap_face_fine.gpen.face_detect.utils.box_utils import decode, decode_landm


class RetinaFaceDetection(object):
    def __init__(self, base_dir, device='cuda', network='RetinaFace-R50'):
        # torch.set_grad_enabled(False)  # BUG!!!
